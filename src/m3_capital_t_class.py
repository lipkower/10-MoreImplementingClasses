    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        v_rect = rg.Rectangle(rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y -
                                       letter_thickness/2), rg.Point(intersection_center.x + letter_thickness/2,
                                                                     intersection_center.y + height -
                                                                     letter_thickness/2))
        h_rect = rg.Rectangle(rg.Point(intersection_center.x - width/2, intersection_center.y -
                                       letter_thickness/2), rg.Point(intersection_center.x + width/2,
